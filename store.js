const STORE = [
        /* 1 */
    {
        ...
        funFact:'Sophisticated investors will use this as a litmus test. People think that founders incorporate in Delaware for tax reasons, but other states offer similar or better tax breaks. Knowledgeable founders choose Delaware for the quality of their courts and speed in which they process legal documents/requests (like forming a corporation) and the second is the existance of the Court of Chancery to rule on corporate legal disputs efficiently and quickly.'
    },
    /* 2 */
    {
        id: 2,
        question: 'What is a principle of lean customer development?',
        answers: [
            'Build it, and they will come',
            'The customer knows best',
            'Why wait for people to come when you can pay them to care',
            "It is better to have 100 people who love you, than 10,000 who do not"
        ],
        correctAnswer: "It is better to have 100 people who love you, than 10,000 who do not",
    ...
    /* 7 */
    {
        ...
        answers: [
            ...
            'A wire-framing technique to simulate the user experience through an application for random people on a piece of paper',
    ...
    /* 8 */
    {
        ...
        funFact:"It's important when choosing a name that people remember. They will likely google your company almost immediately after hearing it and probably wont have you explaining that the 'y's are actually 'i's."
    },
    /* 9 */
    {
        id: 9,
